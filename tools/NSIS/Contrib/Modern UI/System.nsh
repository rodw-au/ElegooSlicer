...
!verbose pop
!echo "NSIS 现代用户界面版本 ${MUI_SYSVERSION} - Copyright 2002-2023 Joost Verburg,汉化：水晶石"
...
!macro MUI_INSERT
  ...
  !ifndef MUI_INSERT
    ...
    !ifdef MUI_PRODUCT | MUI_VERSION
      !warning "已删除MUI_PRODUCT和MUI_VERSION定义。现在请使用普通的Name命令。"
    !endif
...
!macro MUI_FUNCTIONS_DESCRIPTION_BEGIN
  ...
  !warning "Modern UI 宏名称已更改。请将MUI_FUNCTIONS_DESCRIPTION_BEGIN更改为MUI_FUNCTION_DESCRIPTION_BEGIN。"
...
!macro MUI_FUNCTIONS_DESCRIPTION_END
  ...
  !warning "Modern UI 宏的名称已更改。请将MUI_FUNCTIONS_DESCRIPTION_END更改为MUI_FUNCTION_DESCRIPTION_END。"
...
!macro MUI_PAGE_INIT
  ...
  !ifdef MUI_INSERT
    !warning "MUI_[UN]PAGE_* 宏已经在 MUI_LANGUAGE 宏之后被插入。"
  !endif
...
!macro MUI_LANGUAGE NLFID
  ...
  !ifndef MUI_PAGE_UNINSTALLER_PREFIX && MUI_UNINSTALLER
    !ifndef MUI_DISABLE_INSERT_LANGUAGE_AFTER_PAGES_WARNING ; Define this to avoid the warning if you only have custom pages
      !warning "MUI_LANGUAGE 应该在插入 MUI_[UN]PAGE_* 宏之后。"
    !endif
  !endif
...
!macro MUI_LANGDLL_DISPLAY
  ...
  !ifndef MUI_LANGDLL_LANGUAGES
    !warning "MUI_LANGDLL_DISPLAY 应该仅在插入 MUI_LANGUAGE 宏之后使用。"
  !endif
