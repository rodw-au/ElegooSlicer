...
void GLCanvas3D::LayersEditing::render_variable_layer_height_dialog(const GLCanvas3D& canvas) {
    ...
    ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, ImVec4(0.0f, 0.47f, 0.74f, 0.00f));
    ImGui::PushStyleColor(ImGuiCol_FrameBgActive, ImVec4(0.0f, 0.47f, 0.74f, 0.00f));
...
void GLCanvas3D::_render_imgui_select_plate_toolbar()
{
    ...
    if(m_sel_plate_toolbar.show_stats_item)
    {
        ...
        {
            text_clr       = ImVec4(0.0f, 0.47f, 0.74f, 0.2f); // ORCA: All plates slicing NOT complete - Text color
