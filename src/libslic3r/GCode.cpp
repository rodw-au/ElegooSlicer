...
void GCode::_do_export(Print& print, GCodeOutputStream &file, ThumbnailsGeneratorCallback thumbnail_cb)
{
   ...
   
    {
        ...
        if (printer_model.find("Elegoo Neptune") != std::string::npos ||
            ...
            file.write(
                "; Add the Cura_SteamEngine x.x.x tag to the Gcode file so that some printers think it is Gcode generated by Cura\n");
        }
    }
